...
public class ModItems {
    ...
    public static final Item SPEEDRUNNER_SAPLING = registerModBlock(ModBlockItemIds.SPEEDRUNNER_SAPLING, ModBlocks.SPEEDRUNNER_SAPLING, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_PLANKS = registerModBlock(ModBlockItemIds.SPEEDRUNNER_PLANKS, ModBlocks.SPEEDRUNNER_PLANKS, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_SLAB = registerModBlock(ModBlockItemIds.SPEEDRUNNER_SLAB, ModBlocks.SPEEDRUNNER_SLAB, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_STAIRS = registerModBlock(ModBlockItemIds.SPEEDRUNNER_STAIRS, ModBlocks.SPEEDRUNNER_STAIRS, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_FENCE = registerModBlock(ModBlockItemIds.SPEEDRUNNER_FENCE, ModBlocks.SPEEDRUNNER_FENCE, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_FENCE_GATE = registerModBlock(ModBlockItemIds.SPEEDRUNNER_FENCE_GATE, ModBlocks.SPEEDRUNNER_FENCE_GATE, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_BUTTON = registerModBlock(ModBlockItemIds.SPEEDRUNNER_BUTTON, ModBlocks.SPEEDRUNNER_BUTTON, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_PRESSURE_PLATE = registerModBlock(ModBlockItemIds.SPEEDRUNNER_PRESSURE_PLATE, ModBlocks.SPEEDRUNNER_PRESSURE_PLATE, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_TRAPDOOR = registerModBlock(ModBlockItemIds.SPEEDRUNNER_TRAPDOOR, ModBlocks.SPEEDRUNNER_TRAPDOOR, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS));
    public static final Item SPEEDRUNNER_DOOR = registerModBlock(ModBlockItemIds.SPEEDRUNNER_DOOR, ModBlocks.SPEEDRUNNER_DOOR, (block, properties) -> new DoubleHighBlockItem(block, properties.cookingFuel(ModIntProviders.COOKING_TIME_SPEEDRUNNER_ITEMS)));

    public static final Item DEAD_SPEEDRUNNER_LOG = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_LOG, ModBlocks.DEAD_SPEEDRUNNER_LOG, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_WOOD = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_WOOD, ModBlocks.DEAD_SPEEDRUNNER_WOOD, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    ...
    public static final Item DEAD_SPEEDRUNNER_SAPLING = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_SAPLING, ModBlocks.DEAD_SPEEDRUNNER_SAPLING, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    ...
    public static final Item DEAD_SPEEDRUNNER_PLANKS = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_PLANKS, ModBlocks.DEAD_SPEEDRUNNER_PLANKS, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_SLAB = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_SLAB, ModBlocks.DEAD_SPEEDRUNNER_SLAB, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_STAIRS = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_STAIRS, ModBlocks.DEAD_SPEEDRUNNER_STAIRS, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_FENCE = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_FENCE, ModBlocks.DEAD_SPEEDRUNNER_FENCE, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_FENCE_GATE = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_FENCE_GATE, ModBlocks.DEAD_SPEEDRUNNER_FENCE_GATE, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_BUTTON = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_BUTTON, ModBlocks.DEAD_SPEEDRUNNER_BUTTON, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_PRESSURE_PLATE = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_PRESSURE_PLATE, ModBlocks.DEAD_SPEEDRUNNER_PRESSURE_PLATE, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
    public static final Item DEAD_SPEEDRUNNER_TRAPDOOR = registerModBlock(ModBlockItemIds.DEAD_SPEEDRUNNER_TRAPDOOR, ModBlocks.DEAD_SPEEDRUNNER_TRAPDOOR, p -> p.cookingFuel(ModIntProviders.COOKING_TIME_DEAD_SPEEDRUNNER_ITEMS));
