...
import net.dillon.speedrunnermod.loot.mc.RuinedPortalLoot;
...
public class ModChestLootTables extends SimpleFabricLootTableSubProvider {
    public static final ResourceKey<LootTable> MC_ABANDONED_CAMP_BARREL = createLootTable("barrels/mc_abandoned_camp_barrel");
    public static final ResourceKey<LootTable> MC_ABANDONED_CAMP_COMMON_CHEST = createLootTable("chests/mc_abandoned_camp_common_chest");
    public static final ResourceKey<LootTable> MC_ABANDONED_CAMP_SECRET_CHEST = createLootTable("chests/mc_abandoned_camp_secret_chest");
